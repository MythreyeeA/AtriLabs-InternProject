...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox61": {
      "custom": {
        "text": "Over the past 12 years, I've worked with a diverse range of  clients, from startups  to Fortune  500  companies. I love  crafting interfaces that delight  users  and helps businesses grow."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox122": {
      "custom": {
        "text": "What is your  typical timeline for  a project?"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox130": {
      "custom": {
        "text": "4353 Delaware Avenue, San Francsico, USA"
      },
      "callbacks": {
        "onClick": [
          {
